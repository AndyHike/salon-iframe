...
const translations: Record<string, Record<string, string>> = {
  uk: {
    ...
    'contacts.formSuccess': 'Дякуємо! Ми зв’яжемося з вами, щоб уточнити деталі та підтвердити час.',
  ...
  en: {
    ...
    'contacts.formSuccess': 'Thank you! We will contact you to clarify the details and confirm whether the selected time is available.',
  ...
  cs: {
    ...
    'contacts.formSuccess': 'Děkujeme! Ozveme se vám, upřesníme detaily a potvrdíme, zda je vybraný čas volný.',
