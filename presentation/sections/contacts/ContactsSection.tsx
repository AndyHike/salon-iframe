        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
              ...
              {settings.phone && (
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${settings.phone}`} className="text-stone-600 hover:text-[var(--primary-color)] transition-colors">
                      {settings.phone}
                    </a>
                  </div>
                </div>
              ...
              {settings.email && (
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${settings.email}`} className="text-stone-600 hover:text-[var(--primary-color)] transition-colors">
                      {settings.email}
                    </a>
                  </div>
                </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-stone-700 mb-1">{t('contacts.formEmailOptional')}</label>
                <input
                  type="email"
                  id="email"
                  name="email"
              ...
              {submitStatus === 'success' && (
                <div className="p-4 bg-emerald-600 text-white rounded-xl text-center text-sm font-medium shadow-sm">
